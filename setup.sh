...
echo "  2. Store Gmail app password in Keychain for monthly-sync email notifications:"
...
echo "  3. Claude Code skill — i18n-audit: open Claude Code and run /install-skill"
