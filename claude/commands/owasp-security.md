...
- [`~/.claude/skills/owasp-references/languages.md`](~/.claude/skills/owasp-references/languages.md) — per-language security quirks with unsafe/safe examples for 20+ languages.
- [`~/.claude/skills/owasp-references/owasp-report.md`](~/.claude/skills/owasp-references/owasp-report.md) — comprehensive deep-dive on every OWASP 2025–2026 standard.
...
Dart/Flutter, PowerShell, SQL), see [`~/.claude/skills/owasp-references/languages.md`](~/.claude/skills/owasp-references/languages.md).
